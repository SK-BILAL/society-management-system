...
<div class="maintain">
    <center><h1><b>Manage Maintenance</h1></center></b><br> 
    </div>
<center>
<form action="maintenance.php" method="POST">
  ...
  <textarea class="form2" name="f2"  placeholder="Write Details here" id="floatingTextarea2" style="height: 150px" ></textarea></div>
  
</div>
    <div class="mb-3">
    <input type="submit"  name="submit" class="btn btn-dark" value="POST"></div>
    </form></center>
